...
int main()
{
    ...
    PayOffCustomCall the_payoff3(strike);
    VanillaOption option4(the_payoff3, expiry);
    result = simple_monte_carlo4(option4,
                                 spot,
                                 vol,
                                 r,
                                 number_of_paths);
    ...
    PayOffCustomPut the_payoff4(strike);
    VanillaOption option5(the_payoff3, expiry);
    result = simple_monte_carlo4(option5,
                                 spot,
                                 vol,
                                 r,
                                 number_of_paths);
...
// shallow copy: address is also copied with object copying
